UPDATE page_sections SET html_content = '<div class="section-title">🧳 Travel Prep — India to Hof</div>
  <div class="section-sub">9 days to Oct 4 flight (Qatar Airways, Student Club). Ordered online-first — buy/order those categories today, work down through offline errands after. Each item shows where to get it.</div>
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-electronics-powerbank"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-electronics-phonecable"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-electronics-headphones"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-packing-padlock"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
          <label class="cl-label" for="travel-packing-padlock">Padlock for luggage — 1-2</label>
          <div class="cl-source">🛒 Online — Amazon.in</div>
        </div>
        <span class="cl-chip chip-important">Important</span>
      </div>
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-packing-pillow"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-passport"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        ...
        <div class="cl-body">
          <label class="cl-label" for="travel-documents-photos">Passport-size photos (biometric, German format) — 10-12 copies</label>
          <div class="cl-source">🏬 Offline — local photo studio/print shop (cheaper in India)</div>
        </div>
        <span class="cl-chip chip-critical">Critical</span>
      </div>
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-admissionletter"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-arrivalform"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-degreecert"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-btechcert"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-projectreport"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-birthcert"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-vaccination"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-passportcopies"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-docbackup"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-documents-address"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-money-blockedaccount"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-money-bankdocs"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-money-secondcard"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-money-niyo"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-money-netbanking"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-money-emergencycontacts"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-medicines-prescriptioncopies"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-medicines-firstaid"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-medicines-healthinsurance"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-comfort-toiletrykit"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-comfort-towel"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-winterclothing-formal"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-winterclothing-casual"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-winterclothing-ethnic"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      ...
      <div class="cl-item cl-important">
        ...
        <div class="cl-body">
          <label class="cl-label" for="travel-eyewear-specs">Backup pair of spectacles</label>
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-eyewear-sunglasses"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
    ...
    <div class="home-card" style="margin-bottom:16px;">
      <div class="home-card-head">
        <span class="home-card-title">✅ Final Checks — Oct 2-4</span>
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-finalchecks-packweigh"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-finalchecks-printtickets"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-finalchecks-chargedevices"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-finalchecks-confirmcabin"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-critical">
        <input type="checkbox" class="cl-check persist-check" id="travel-finalchecks-flightdetails"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-optional">
        <input type="checkbox" class="cl-check persist-check" id="travel-finalchecks-snacks"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
      ...
      <div class="cl-item cl-important">
        <input type="checkbox" class="cl-check persist-check" id="travel-finalchecks-warmlayer"  onchange="saveCheck(this); updateTravelProgress()">
        <div class="cl-body">
