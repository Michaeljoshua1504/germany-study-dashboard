...
const DEFAULT_NEXT_STEPS = [
  ...
  { text:'Download enrollment certificate', detail:'Available from Primuss Portal once Zugangsdaten (university login) arrives.', chip:'After login', urgency:'blue', section:'action', done:false, sort_order:4 },
  { text:'Deutschlandstipendium', detail:'Apply at Hof after semester starts.', chip:'After Oct 1', urgency:'blue', section:'action', done:false, sort_order:5 },
];
